...
Hooks.once('init', async function() {
  ...
  Actors.registerSheet("pnp", PnpActorSheet, { makeDefault: true });
  Items.unregisterSheet("core", ItemSheet);
  Items.registerSheet("pnp", PnpItemSheet, { makeDefault: true });
...
async function createItemMacro(data, slot) {
  ...
  const command = `game.pnp.rollItemMacro("${data.uuid}");`;
