...
export class PnpActorSheet extends ActorSheet {
  ...
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      classes: ["pnp", "sheet", "actor"],
      template: "systems/pnp/templates/actor/actor-sheet.html",
      width: 600,
      height: 600,
  ...
  /** @override */
  get template() {
    return `systems/pnp/templates/actor/actor-${this.actor.type}-sheet.html`;
  }
  ...
  _prepareCharacterData(context) {
    ...
    for (let [k, v] of Object.entries(context.system.abilities)) {
      v.label = game.i18n.localize(CONFIG.PNP.abilities[k]) ?? k;
    }

    // talents
    for (let [k, v] of Object.entries(context.system.talents)) {
      v.label = game.i18n.localize(CONFIG.PNP.talents[k]) ?? k;
    }
  }
